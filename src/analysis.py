...
def venue_wise_analysis(df):
    ...
    print(venue_matches.sort_values(ascending=False).head(10))

    print("\nAVERAGE RUNS PER VENUE")
    print(venue_runs.sort_values(ascending=False).head(10))
